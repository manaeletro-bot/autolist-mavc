...
*   **[Vora DOC 010](file:///c:/Users/marci/Auto%20list/VORA%20CLOUD%20-%20OS/documentacao/Vora%20DOC/010.md):** Implementação da regra de isolamento de dados: novos lojistas cadastrados iniciam com inventário zerado e persistem seus veículos em banco isolado (`.eq('user_id', userId)`), enquanto os usuários de demonstração (`lojista@autolist.com` e `expirado@autolist.com`) utilizam sandbox com **auto-reset automático** que restaura os 6 veículos padrão (`DEFAULT_SEED_VEHICLES`) a cada login/logout.
*   **[Vora DOC 011](file:///c:/Users/marci/Auto%20list/VORA%20CLOUD%20-%20OS/documentacao/Vora%20DOC/011.md):** Otimização de UX para campos numéricos com auto-seleção `onFocus select`, eliminação de zero residual inicial e redesign completo da seção de **Débitos & Documentação Pendente** com estilo limpo de alto contraste (fundo claro `bg-slate-50`, contorno fino de 1px, rótulos pretos e caixas de texto brancas).
*   **[Vora DOC 012](file:///c:/Users/marci/Auto%20list/VORA%20CLOUD%20-%20OS/documentacao/Vora%20DOC/012.md):** Integração global de inputs de moedas usando o componente `CurrencyInput`, formatação monetária brasileira (BRL) robusta e manual baseada em regex (milhares com ponto e decimais com vírgula), e reset automático de scroll no container principal de navegação SPA.
